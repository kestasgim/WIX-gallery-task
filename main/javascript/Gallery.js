(function () {
  ...
  Gallery.prototype.doSearch = function (query, moduleId) {
    //var searchResults = 
    this._imageFinder.search(query, moduleId, this);
  ...
  Gallery.prototype._onSearchButtonClick = function (e) {
    ...
    var moduleId = this._searchModuleDrpNode.value;
  ...
  Gallery.prototype._createInterface = function () {
    ...
    this._searchModuleDrpNode = document.createElement('select');
    this._searchModuleDrpNode.appendChild(new Option('static', 'static'));
    this._searchModuleDrpNode.appendChild(new Option('flickr', 'flickr'));
    this._controlsNode.appendChild(this._searchModuleDrpNode);
